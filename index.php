      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
         ...
         <?php
            ...
            $element_count =[$post_counts,$post_published_counts, $post_draft_counts, $comments_counts,$unapproved_comment_count, $users_counts,$subscriber_count, $categories_counts];
             for($i =0; $i<8; $i++){
