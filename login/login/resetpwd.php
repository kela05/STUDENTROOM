...
<?php
include '../nav_head/navbar.php';
include 'dbconn.php';
include '../nav_head/header.html';
...
<?php
        ...
        header("Location: http://localhost/demo/student_room.php/login/login.php");
    }
}else{
    header("Locatin: http://localhost/demo/student_room.php/login/login.php");
}
?>
